...
function App() {
    ...
    const questionList = [
        ...
        {
            q: [
                "친구가 평소와 비슷한 모습으로 무엇이 달라졌는지 맞춰보라 한다",
            ],
            a: [
                { type: "토끼", text: "내가 또 한 섬세함이 있지" },
    ...
    function setPet() {
        setPetContents(
            // 최고값은 = accmulatror(누산값), 현재값 = currentValue
